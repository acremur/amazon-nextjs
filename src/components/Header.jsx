...
const Header = () => {
    ...
    return (
        <header>
           <div className='fixed z-30 h-18 w-full flex items-center bg-amazon_blue p-1 flex-grow py-2'>
           ...
           <div className="fixed top-16 z-30 h-18 w-full flex items-center space-x-3 p-2 pl-6 bg-amazon_blue-light text-white text-sm">
